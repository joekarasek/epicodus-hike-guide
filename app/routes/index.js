  ...
  model() {
    ...
    .then(function(result) {
      ...
      result.places.forEach(function(place, index) {
        promiseArray.push($.get('http://api.openweathermap.org/data/2.5/weather?lat='+ place.lat +'&lon=' + place.lon + '&appid=0bc1f375eec970019c6d88bce9494c4c', function(response) {
